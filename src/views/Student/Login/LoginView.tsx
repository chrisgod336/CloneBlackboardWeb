...
import { faArrowLeftLong, faArrowRightToBracket, faGraduationCap } from "@fortawesome/free-solid-svg-icons";

import { ReactBootstrapComponents } from "../../../utils/Bootstrap";
import { login as get } from "./LoginModelView";
            ...
            <div style={{
                ...
                <ReactBootstrapComponents.Card width={'50%'}>
                    ...
                    <div style={{
                        ...
                        <ReactBootstrapComponents.Icon name={faGraduationCap} size="7x" color={BootstrapColors.primary}/>
                    </div>
